...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hi! my name is **Whitney Willoz** and I'm a *computer science* major. I graduated with 31 students at my high school in lone tree. I'm looking forward to doing well in this class. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Data scientists job is to find, clean, and organize data for companies in a way any person can understand. website link: https://www.northeastern.edu/graduate/blog/data-science-careers-shaping-our-future/  
    image link:https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.proschoolonline.com%2Fblog%2Fdata-science-skills&psig=AOvVaw2qqpeHgWr7LjtA3z34owjB&ust=1630076549815000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCOif_sD6zvICFQAAAAAdAAAAABAD
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I love movie datasets and crime datasets. 
